	...
	*//**
    ...
    dataValidation() {
		return new ArgHandler('Sheet.dataValidation')
			.case('string', address => {
				if (this._dataValidations[address] && this._dataValidations[address].children.length) {
                    try {
                        return {
                            ...
                            formula1: this._dataValidations[address].children[0] ? this._dataValidations[address].children[0].children[0] : undefined,
                            formula2: this._dataValidations[address].children[1] ? this._dataValidations[address].children[1].children[0] : undefined
                        };
                    } catch (e) {
                        console.log('ERROR: ', this._dataValidations[address].children[0])
                    }
				} else {
					return false;
				}
